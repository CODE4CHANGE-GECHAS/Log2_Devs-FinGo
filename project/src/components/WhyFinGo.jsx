...
import { AlertTriangle, TrendingUp, BrainCircuit, ArrowRight } from 'lucide-react';

const WhyFinGo = () => {
  const painPoints = [
    {
      icon: <AlertTriangle className="h-8 w-8" />,
      title: "Financial Tracking Struggles",
      description: "Manual tracking leads to errors and missed opportunities"
    },
    {
      icon: <TrendingUp className="h-8 w-8" />,
      title: "Late Payments Impact",
      description: "Cash flow disruptions affecting business growth"
    },
    {
      icon: <BrainCircuit className="h-8 w-8" />,
      title: "Lack of AI Insights",
      description: "Traditional tools miss crucial financial patterns"
    }
  ];
    ...
    <div className="py-20 px-6 md:px-12 bg-gradient-to-b from-black to-[#1a1a1a] overflow-hidden">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            Why Small Businesses Need FinGo
          </motion.h2>
